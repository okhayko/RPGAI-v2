...
export const RainIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M6,14.03A1,1 0 0,1 7,15.03C7,15.58 6.55,16.03 6,16.03C3.24,16.03 1,13.79 1,11.03C1,8.27 3.24,6.03 6,6.03C7,3.68 9.3,2.03 12,2.03C15.43,2.03 18.24,4.69 18.5,8.06L19,8.03A4,4 0 0,1 23,12.03A4,4 0 0,1 19,16.03H18C17.45,16.03 17,15.58 17,15.03C17,14.47 17.45,14.03 18,14.03H19A2,2 0 0,0 21,12.03A2,2 0 0,0 19,10.03H17V9.03C17,6.27 14.76,4.03 12,4.03C9.5,4.03 7.45,5.84 7.06,8.21C6.73,8.09 6.37,8.03 6,8.03A3,3 0 0,0 3,11.03A3,3 0 0,0 6,14.03M12,14.15L13.8,16.5L11.5,19.85L9.7,17.5L12,14.15M15.8,17.5L14,15.15L16.3,11.8L18.1,14.15L15.8,17.5M8.2,17.5L5.9,14.15L7.7,11.8L10,15.15L8.2,17.5Z" />
    </svg>
);
...
export const WindIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M4,10A1,1 0 0,1 3,9A1,1 0 0,1 4,8H12A2,2 0 0,0 14,6A2,2 0 0,0 12,4C11.45,4 10.95,4.22 10.59,4.59C10.2,5 9.56,5 9.17,4.59C8.78,4.2 8.78,3.56 9.17,3.17C9.9,2.45 10.9,2 12,2A4,4 0 0,1 16,6A4,4 0 0,1 12,10H4M19,12A1,1 0 0,0 20,11A1,1 0 0,0 19,10C18.72,10 18.47,10.11 18.29,10.29C17.9,10.68 17.27,10.68 16.88,10.29C16.5,9.9 16.5,9.27 16.88,8.88C17.42,8.34 18.17,8 19,8A3,3 0 0,1 22,11A3,3 0 0,1 19,14H5A1,1 0 0,1 4,13A1,1 0 0,1 5,12H19M18,16A4,4 0 0,1 22,20A4,4 0 0,1 18,24C16.9,24 15.9,23.55 15.17,22.83C14.78,22.44 14.78,21.8 15.17,21.41C15.56,21.02 16.2,21.02 16.59,21.41C16.95,21.78 17.45,22 18,22A2,2 0 0,0 20,20A2,2 0 0,0 18,18H4A1,1 0 0,1 3,17A1,1 0 0,1 4,16H18Z" />
    </svg>
);

export const SnowIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12,2L14.09,8.26L20,9L14.09,9.74L12,16L9.91,9.74L4,9L9.91,8.26L12,2M16.5,3L18,6.5L21.5,8L18,8.5L16.5,12L15,8.5L11.5,8L15,6.5L16.5,3M7.5,12L9,15.5L12.5,17L9,17.5L7.5,21L6,17.5L2.5,17L6,15.5L7.5,12M8.5,2L10,5.5L13.5,7L10,7.5L8.5,11L7,7.5L3.5,7L7,5.5L8.5,2Z" />
    </svg>
);

export const FogIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M3,15H13A1,1 0 0,1 14,16A1,1 0 0,1 13,17H3A1,1 0 0,1 2,16A1,1 0 0,1 3,15M16,15H21A1,1 0 0,1 22,16A1,1 0 0,1 21,17H16A1,1 0 0,1 15,16A1,1 0 0,1 16,15M1,19H11A1,1 0 0,1 12,20A1,1 0 0,1 11,21H1A1,1 0 0,1 0,20A1,1 0 0,1 1,19M14,19H23A1,1 0 0,1 24,20A1,1 0 0,1 23,21H14A1,1 0 0,1 13,20A1,1 0 0,1 14,19M3,7A4,4 0 0,1 7,3A4,4 0 0,1 11,7H3M13,7A4,4 0 0,1 17,3A4,4 0 0,1 21,7H13M1,11H5A1,1 0 0,1 6,12A1,1 0 0,1 5,13H1A1,1 0 0,1 0,12A1,1 0 0,1 1,11M8,11H23A1,1 0 0,1 24,12A1,1 0 0,1 23,13H8A1,1 0 0,1 7,12A1,1 0 0,1 8,11Z" />
    </svg>
);

export const StormIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M6,16.5C3.24,16.5 1,14.26 1,11.5C1,8.74 3.24,6.5 6,6.5C7,4.15 9.3,2.5 12,2.5C15.43,2.5 18.24,5.16 18.5,8.53L19,8.5A4,4 0 0,1 23,12.5A4,4 0 0,1 19,16.5H18C17.45,16.5 17,16.05 17,15.5C17,14.95 17.45,14.5 18,14.5H19A2,2 0 0,0 21,12.5A2,2 0 0,0 19,10.5H17V9.5C17,6.74 14.76,4.5 12,4.5C9.5,4.5 7.45,6.32 7.06,8.69C6.73,8.57 6.37,8.5 6,8.5A3,3 0 0,0 3,11.5A3,3 0 0,0 6,14.5A1,1 0 0,1 7,15.5A1,1 0 0,1 6,16.5M11,18L13,16L11,21L9,19L11,18M16.5,18L18.5,16L16.5,21L14.5,19L16.5,18M6.5,18L8.5,16L6.5,21L4.5,19L6.5,18Z" />
    </svg>
);
